        ...
        Ext.create('Rally.ui.dialog.Dialog', {
                                        ...
                                        },
                                        {
                                            ...
                                            listeners: {
                                                mouseover: function(gridView,cell,rowIdx,cellIdx,event,record) { 
                                                    if (!cell.tooltip) {
                                                        cell.tooltip = Ext.create('Rally.ui.tooltip.ToolTip' , {
                                                            target: cell,
                                                            autoShow: true,
                                                            html:   
            ...
            nonRAIDStoreConfig: function() {
                ...
                if (this.record.hasField('c_RAIDType') ){
                    switch (this.record.self.ordinal) { //Switch statement used in case we want different plans for each portfolio level
                        case 1:
                            retval.filters = {
                                    property: 'c_RAIDType',
                                    operator: '=',
